...
{
    public class GetLatest5BlogsQueryHandler(IRepository<Blog> repository, IMapper mapper) : IRequestHandler<GetLatest5BlogsQuery, BaseResult<List<GetLatest5BlogsQueryResult>>>
    {
